 ...
 * @author Jose Jesus
 */
@WebServlet(name = "AnadeProducto", urlPatterns = {"/AnadeProducto"})
public class AnadeProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String siguiente = "productos.jsp";
        String nombre = request.getParameter("nombre");
        String cantidadS = request.getParameter("cantidad");
        String precioS = request.getParameter("precio");
        Integer cantidad = Integer.valueOf(cantidadS);
        Float precio = Float.valueOf(precioS);
        Producto producto = new Producto(nombre, cantidad, precio);
        ProductoJpaController productoJPAC = new ProductoJpaController();
        try {
            productoJPAC.create(producto);
